...
int main(int argc, char **argv)
{
    ...
    cout << "Description: Implement a binary tree using an array, vector or linked list." << endl
         ...
         << "In addition to the traversals, print out the binary tree by level. Show the parent-child relationship for all the nodes of the tree." << endl;

    int data[] = {19, 13, 888, 109, 55, 118, 89, 33, 1001, 18, 44, 88, 12, 24, 49, 7, 25, 59, 28};
	Tree *root = newTreeNode(data[0]);
    for(int i = 1; i < 18; i++){
        	insertTreeNode(root, data[i]);
    }
    cout << "IN order print: ";
    ...
    cout << endl << "Post order print: ";
    printTreePostOrder(root);
    cout << endl << "BreadthFirst print: ";
